...
Bind Protocol v4.0, namespace, iteration/invocation, `Invocation Mode: Export Acquisition`, pinned snapshot/environment, exact approved artifact/projection set, and every multi-file read/write/forbidden target.
